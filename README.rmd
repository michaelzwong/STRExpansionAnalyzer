...
Use the Shiny App to view results from the ShortTandemRepeatsLoci dataset. You
can specify the Z-Score used in calculating variability of a motif and plot
the different types of graphs to understand the data better.

![shiny_distribution_count](./inst/extdata/shiny_distribution_count.png)

![shiny_distribution_density](./inst/extdata/shiny_distribution_density.png)
